...
//bits in each byte are swapped in nrzi() so that the first bit sent is the lsb of the AIS packet (left to right)
byte packet[]={0xaa,0xaa,0xaa,0x7e,0x4,0x57,0x9e,0x5b,0xe1,0x60,0x00,0x06,0x1d,0x0f,
               0x30,0x0b,0x9f,0x1b,0x1d,0x20,0x00,0xf0,0x00,0x80,0x6b,0x1c,0xe1,0xfd,0xfe};
byte nrziPacket[29];
...
void setup()
{
  ...
  Heltec.display -> drawString(0, 20, "Starting AIS transmissions");
